...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav navbar-nav_custom">
                    <li class="nav-item nav-link_disappear">
                        <a class="nav-link px-4 active-link" href="">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4" href="#about">ABOUT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4" href="#education">EDUCATION/WORK</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <button type="submit" class="btn btn-orange mr-2 mt-2">Download Resume</button>
    ...
    <section class="education-section">
        <div class="container text-center">
            <span class="pb-2 caption" id="education">EDUCATION/WORK</span>
            <div class="grid-wrapper mt-5">
                <div class="wow animate__animated animate__bounce animate__slideInRight education-section_junior text-left">
                    <h6 class="mb-3">Dipoma in Human Computer Interaction</h6>
    ...
    <section class="portfolio-section">
        <div class="container text-center">
            ...
            <button type="button" class="btn btn-orange">Load More</button>
        </div>
    </section>
    <!-- What I Do Section -->
            ...
            <div class="row mt-5">
                <div class="col-md-6 mt-2">
                    <form>
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="15" placeholder="Message"></textarea>
                        </div>
